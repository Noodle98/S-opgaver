...
label_frame_aircraft.grid(padx=(5, 10), pady=(10, 15))
...
tree_aircraft = ttk.Treeview(frame_tree_aircraft, columns=("id", "weight", "destination"), yscrollcommand=tree_scrollbar_aircraft.set, selectmode="browse")
...
tree_aircraft.column('weight', width=75, anchor=tk.E)
tree_aircraft.column('destination', width=200, anchor=tk.W)
...
label_weight_aircraft = tk.Label(frame1_aircraft, text="Weight")
label_destination_aircraft = tk.Label(frame1_aircraft, text="Destination")
label_weather_aircraft = tk.Label(frame1_aircraft, text="Weather")

# labels get grid functionality
label_id_aircraft.grid(column=0, row=0)
label_weight_aircraft.grid(column=1, row=0)
label_destination_aircraft.grid(column=2, row=0)
label_weather_aircraft.grid(column=3, row=0)

# entries
entry_id_aircraft = tk.Entry(frame1_aircraft, width=4)
entry_weight_aircraft = tk.Entry(frame1_aircraft, width=7)
entry_destination_aircraft = tk.Entry(frame1_aircraft, width=20)
entry_weather_aircraft = tk.Entry(frame1_aircraft, width=12)

# entries get grid functionality
entry_id_aircraft.grid(column=0, row=1, padx=8)
entry_weight_aircraft.grid(column=1, row=1, padx=8)
entry_destination_aircraft.grid(column=2, row=1, padx=8)
entry_weather_aircraft.grid(column=3, row=1, padx=(8, 0))
...
label_frame_transport.grid(padx=(5, 10), pady=(10, 15))
...
tree_transport = ttk.Treeview(frame_tree_transport, columns=("id", "weight", "destination"), yscrollcommand=tree_scrollbar_transport.set, selectmode="browse")
...
tree_transport.column('weight', width=75, anchor=tk.E)
tree_transport.column('destination', width=200, anchor=tk.W)
...
label_weight_transport = tk.Label(frame1_transport, text="Weight")
label_destination_transport = tk.Label(frame1_transport, text="Destination")
label_weather_transport = tk.Label(frame1_transport, text="Weather")

# labels get grid functionality
label_id_transport.grid(column=0, row=0)
label_weight_transport.grid(column=1, row=0)
label_destination_transport.grid(column=2, row=0)
label_weather_transport.grid(column=3, row=0)

# entries
entry_id_transport = tk.Entry(frame1_transport, width=4)
entry_weight_transport = tk.Entry(frame1_transport, width=7)
entry_destination_transport = tk.Entry(frame1_transport, width=20)
entry_weather_transport = tk.Entry(frame1_transport, width=12)

# entries get grid functionality
entry_id_transport.grid(column=0, row=1, padx=8)
entry_weight_transport.grid(column=1, row=1, padx=8)
entry_destination_transport.grid(column=2, row=1, padx=8)
entry_weather_transport.grid(column=3, row=1, padx=(8, 0))
